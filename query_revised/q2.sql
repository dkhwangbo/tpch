...
create table q2_minimum_cost_supplier_tmp1 (s_acctbal double, s_name text, n_name text, p_partkey int8, ps_supplycost double, p_mfgr text, s_address text, s_phone text, s_comment text);
